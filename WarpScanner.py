V=76
# Auto-install and import cryptography
try:
...
def info():
    ...
    table.add_row("ViP","1 - Telegram")
    table.add_row("ViP","2 - github")
    console.print(table)
    print('\nEnter a Number\n')
    ...
    if whats2=='0':
        ...
        os.system("termux-open-url 'https://github.com/ViP/'")
def check_ipv6():
    try:
...
def fetch_config_from_api():
    ...
    def file_o():
            try:
                response = urllib.request.urlopen("http://s9.serv00.com:1074/ViP/api/wirekey", timeout=30).read().decode('utf-8')
                return response
            except Exception:
                response = requests.get("http://s9.serv00.com:1074/ViP/api/wirekey", timeout=30)
                return response.text
    b = file_o()
    b=b.split("\n")
...
{{
  ...
  [
    ...
    {{
    "type": "wireguard",
    "tag": "Tel=@ViP Warp-Main1",
    "detour": "Tel=@ViP Warp-IR1",
    "local_address": [
        "172.16.0.2/32",
        "{all_key2[0]}"
    ],
...
def main3():
    ...
    {{
    "type": "wireguard",
    "tag": "Tel=@ViP Warp-Main{wire_c}",
    "detour": "Tel=@ViP Warp-IR{wire_c}",
    "local_address": [
        "172.16.0.2/32",
        "{all_key2[0]}"
    ],
...
def start_menu():
    ...
    rprint("[bold red]by Telegram= @ViP[/bold red]")
    for key, value in options.items():
        rprint(f" [bold yellow]{key}[/bold yellow]: {value}")
...
if __name__ == "__main__":
    ...
    if what =='1':
        ...
        api_url = 'http://s9.serv00.com:1074/ViP/api/wirekey'
...
""")
        ...
        text=f'''
{name}() {{
bash <(curl -fsSL https://raw.githubusercontent.com/mjjku/WarpScanner/main/install.sh)
}}\n'''
